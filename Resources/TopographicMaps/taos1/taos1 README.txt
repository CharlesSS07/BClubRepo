...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=taos1&box=-105.436854,36.758022,-106.109606,36.219038
...
-----------
  ...
  * taos1 Height Map (ASTER 30m).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * taos1 Height Map (SRTM3 v4.1).png
  ...
  * taos1 Height Map (SRTM30 Plus).png
  ...
  * taos1 Height Map (USGS NED 10m).png
...
These heightmaps were adjusted such that 1781m (actual) is equal to 40m in
