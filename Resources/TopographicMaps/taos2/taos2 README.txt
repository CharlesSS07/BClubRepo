...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=taos2&box=-104.768497,36.970800,-105.443124,36.431817
...
-----------
  ...
  * taos2 Height Map (ASTER 30m).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * taos2 Height Map (SRTM3 v4.1).png
  ...
  * taos2 Height Map (SRTM30 Plus).png
  ...
  * taos2 Height Map (USGS NED 10m).png
...
These heightmaps were adjusted such that 1840m (actual) is equal to 40m in
